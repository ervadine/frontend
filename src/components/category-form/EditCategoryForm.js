// components/admin/EditCategoryForm.js
...
const EditCategoryForm = () => {
  ...
  const parentCategories = useSelector(selectTopLevelCategories);
  ...
  useEffect(() => {
    if (category && category._id === id) {
      setFormData({
        ...
        seo: category.seo || { title: '', description: '', slug: '' },
  ...
  const loadCategory = async () => {
    try {
      ...
      setErrors({ fetch: error || 'Failed to load category' });
      setLocalLoading(false);
    }
  };
  ...
  const loadParentCategories = async () => {
    try {
      ...
      setErrors(prev => ({ 
        ...prev, 
        load: 'Failed to load parent categories' 
      }));
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.image.file) {
        submitData.append('imageFile', formData.image.file);
        submitData.append('image[alt]', formData.image.alt);
      } else if (formData.image.preview && !formData.image.file) {
        // If no new file but existing preview (URL), keep the existing image data
        submitData.append('image[url]', formData.image.preview);
        submitData.append('image[alt]', formData.image.alt);
      }
          ...
          <div className="col-12">
            <div className="card">
              <div className="card-body text-center py-5">
                ...
                <p className="mt-2 mb-0">Loading category data...</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="card">
              <div className="card-body text-center py-5">
                <div className="alert alert-danger" role="alert">
                  ...
                  <p className="mb-0">{errors.fetch}</p>
                </div>
  ...
  const filteredParentCategories = parentCategories.filter(cat => cat._id !== id);
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="row mb-4">
                  <div className="col-12">
                    <h6 className="border-bottom pb-2">Image</h6>
                  </div>
                  ...
                  {(formData.image.preview) && (
                    <div className="col-12 mb-3">
                      ...
                      <div className="form-text text-muted mt-1">
                        {formData.image.file ? 'New image selected' : 'Current category image'}
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="row mb-4">
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    <div className="form-text">
                      Changing the slug may affect existing URLs
                    </div>
                  </div>
